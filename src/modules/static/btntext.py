...
USERS = "💃 Пользователи"
EVERYONE = "🎉 Все"
YANDEX_INTERNSHIP_NOT_SIGNED_UP = "❌🧑‍💼 Не зарегистрированные пользователи Яндекс Стажировки"
YANDEX_INTERNSHIP_SIGNED_UP = "🧑‍💼 Зарегистрированные пользователи Яндекс Стажировки"
YANDEX_INTERNSHIP_ENROLLED = "✅‍✨🧑‍💼 Участники Яндекс Стажировки"
YANDEX_INTERNSHIP_NOT_ENROLLED = "❌✨🧑‍💼 Не участники Яндекс Стажировки"
YANDEX_INTERNSHIP_FLOW_STARTED = "✅‍🪷🧑‍💼 Участники недели мотивации"
YANDEX_INTERNSHIP_NOT_FLOW_STARTED = "❌‍🪷🧑‍💼 Не участники недели мотивации"

# Generic actions
CONFIRM = "✅ Подтвердить"
CANCEL = "❌ Отмена"
DELETE_CONFIRM = "❌ Подтвердить удаление"
DELETE_CANCEL = "🎉 Отменить удаление"

# Coworking buttons
OPEN_COWORKING = "🟢 Открыть"
CLOSE_COWORKING = "🔴 Закрыть"
EVENT_OPEN_COWORKING = "🟡 Открыть на мероприятие"
EVENT_CLOSE_COWORKING = "⛔️ Закрыть на мероприятие"
TEMP_CLOSE_COWORKING = "🟠 Временно закрыть"
...
BOT_SKILL_NAVIGATION = "🧭 Навигация"
